    ...
    <asp:Panel ID="Panel1" runat="server" style="background-color: #CCCCCC">
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style9"><strong>Onaysiz Tarif listesi</strong></td>
            </tr>
        </table>
    </asp:Panel>
    <asp:Panel ID="Panel2" runat="server">
                ...
                <table class="auto-style1">
                    <tr>
                        <td class="auto-style3">
                            <asp:Label ID="Label1" runat="server" style="font-weight: 700; font-size: x-large" Text='<%# Eval("TarifAd") %>'></asp:Label>
                        </td>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style9"><strong>Onayli Tarif listesi</strong></td>
            </tr>
        </table>
    </asp:Panel>
